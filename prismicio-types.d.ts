...
/**
 * Item in *AlternationgText → Default → Primary → Text Group*
 */
export interface ALternationgTextSliceDefaultPrimaryTextGroupItem {
  /**
   * Heading field in *AlternationgText → Default → Primary → Text Group*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: a_lternationg_text.default.primary.text_group[].heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  heading: prismic.TitleField;

  /**
   * Body field in *AlternationgText → Default → Primary → Text Group*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: a_lternationg_text.default.primary.text_group[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
/**
 * Primary content in *AlternationgText → Default → Primary*
 */
export interface ALternationgTextSliceDefaultPrimary {
  /**
   * Text Group field in *AlternationgText → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: a_lternationg_text.default.primary.text_group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  text_group: prismic.GroupField<
    Simplify<ALternationgTextSliceDefaultPrimaryTextGroupItem>
  >;
}

/**
 * Default variation for AlternationgText Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ALternationgTextSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ALternationgTextSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *AlternationgText*
 */
type ALternationgTextSliceVariation = ALternationgTextSliceDefault;

/**
 * AlternationgText Shared Slice
 *
 * - **API ID**: `a_lternationg_text`
 * - **Description**: ALternationgText
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ALternationgTextSlice = prismic.SharedSlice<
  "a_lternationg_text",
  ALternationgTextSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      ALternationgTextSlice,
      ALternationgTextSliceDefaultPrimaryTextGroupItem,
      ALternationgTextSliceDefaultPrimary,
      ALternationgTextSliceVariation,
      ALternationgTextSliceDefault,
      BigTextSlice,
      BigTextSliceVariation,
      BigTextSliceDefault,
      CarouselSlice,
